...
jogador("dyogo_alves", "flamengo", 12, "goleiro", "vermelho", "preto", "ambos", "campeonato_carioca", "não", "não", "brasileiro").
jogador("lucas_furtado", "flamengo", 22, "goleiro", "vermelho", "preto", "ambos", "campeonato_carioca", "não", "não", "brasileiro").
jogador("andrew", "flamengo", 30, "goleiro", "vermelho", "preto", "ambos", "campeonato_carioca", "não", "não", "brasileiro").
jogador("eduardo_jung", "flamengo", 31, "goleiro", "vermelho", "preto", "ambos", "campeonato_carioca", "não", "não", "brasileiro").
jogador("lucyan", "flamengo", 2, "lateral_direito", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("daniel_sales", "flamengo", 6, "lateral_direito", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("jose_welinton", "flamengo", 3, "lateral_esquerdo", "vermelho", "preto", "esquerdo", "campeonato_carioca", "não", "não", "brasileiro").
jogador("joão_carbone", "flamengo", 13, "lateral_esquerdo", "vermelho", "preto", "esquerdo", "campeonato_carioca", "não", "não", "brasileiro").
jogador("ainoã", "flamengo", 16, "lateral_esquerdo", "vermelho", "preto", "esquerdo", "campeonato_carioca", "não", "não", "brasileiro").
jogador("cleiton", "flamengo", 4, "zagueiro", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("felipe_vieira", "flamengo", 5, "zagueiro", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("iago", "flamengo", 14, "zagueiro", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("da_mata", "flamengo", 15, "zagueiro", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("daniel_rogério", "flamengo", 17, "volante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("rayan_lucas", "flamengo", 18, "volante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("fabiano", "flamengo", 19, "volante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("caio_garcia", "flamengo", 20, "volante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("joão_victor", "flamengo", 21, "volante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("rafael", "flamengo", 23, "meia", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("guilherme", "flamengo", 24, "meia", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("lorran", "flamengo", 25, "meia", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("thiaguinho", "flamengo", 26, "atacante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("felipe_teresa", "flamengo", 27, "atacante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("wallace_yan", "flamengo", 28, "atacante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("shola", "flamengo", 29, "atacante", "vermelho", "preto", "esquerdo", "campeonato_carioca", "não", "não", "nigeriano").
jogador("carlinhos", "flamengo", 22, "atacante", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("agustín_rossi", "flamengo", 12, "goleiro", "vermelho", "preto", "ambos", "copa_libertadores_da_américa", "não", "sim", "argentino").
jogador("wesley", "flamengo", 2, "lateral_direito", "vermelho", "preto", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("leo_ortiz", "flamengo", 3, "zagueiro", "vermelho", "preto", "direito", "campeonato_brasileiro", "não", "não", "brasileiro").
jogador("leo_pereira", "flamengo", 4, "zagueiro", "vermelho", "preto", "esquerdo", "campeonato_brasileiro", "não", "não", "brasileiro").
jogador("alex_sandro", "flamengo", 6, "lateral_esquerdo", "vermelho", "preto", "esquerdo", "liga_dos_campeões_da_uefa", "sim", "sim", "brasileiro").
jogador("erick_pulgar", "flamengo", 5, "volante", "vermelho", "preto", "direito", "copa_libertadores_da_américa", "não", "não", "chileno").
jogador("gerson", "flamengo", 8, "meia", "vermelho", "preto", "esquerdo", "campeonato_brasileiro", "sim", "sim", "brasileiro").
jogador("nico_de_la_cruz", "flamengo", 10, "meia", "vermelho", "preto", "esquerdo", "copa_libertadores_da_américa", "não", "não", "uruguaio").
jogador("matheus_goncalves", "flamengo", 11, "meia", "vermelho", "preto", "direito", "campeonato_brasileiro", "não", "não", "brasileiro").
jogador("charly_alcaraz", "flamengo", 7, "atacante", "vermelho", "preto", "esquerdo", "copa_libertadores_da_américa", "não", "não", "argentino").
jogador("bruno_henrique", "flamengo", 27, "atacante", "vermelho", "preto", "esquerdo", "campeonato_brasileiro", "sim", "não", "brasileiro").
jogador("fabio", "fluminense", 1, "goleiro", "verde", "grená", "direito", "copa_do_brasil", "não", "não", "brasileiro").
jogador("samuel_xavier", "fluminense", 2, "lateral_direito", "verde", "grená", "direito", "copa_libertadores_da_américa", "não", "não", "brasileiro").
jogador("thiago_silva", "fluminense", 3, "zagueiro", "verde", "grená", "direito", "liga_dos_campeões_da_uefa", "sim", "sim", "brasileiro").
jogador("juan_freytes", "fluminense", 22, "zagueiro", "verde", "grená", "esquerdo", "campeonato_peruano", "não", "não", "argentino").
jogador("gabriel_fuentes", "fluminense", 12, "lateral_esquerdo", "verde", "grená", "esquerdo", "campeonato_colombiano", "não", "não", "colombiano").
jogador("martinelli", "fluminense", 8, "volante", "verde", "grená", "direito", "copa_libertadores_da_américa", "não", "não", "brasileiro").
jogador("hercules", "fluminense", 35, "volante", "verde", "grená", "direito", "campeonato_carioca", "não", "não", "brasileiro").
jogador("jhon_arias", "fluminense", 21, "meia", "verde", "grená", "direito", "recopa_sul-americana", "sim", "não", "colombiano").
jogador("paulo_henrique_ganso", "fluminense", 10, "meia", "verde", "grená", "esquerdo", "copa_sul-americana", "sim", "sim", "brasileiro").
jogador("agustin_canobbio", "fluminense", 17, "atacante", "verde", "grená", "direito", "campeonato_uruguaio", "sim", "não", "uruguaio").
